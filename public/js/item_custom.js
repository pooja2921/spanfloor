...
$(document).ready(function() {
    // $("input[name=tax").closest(".input-group").hide();
    $('input[name="apply_tax"]').click(function() {
        if ($(this).is(":checked") == true) {
            $("input[name=tax").closest(".input-group").css("display", "flex");
        } else {
            $("input[name=tax").closest(".input-group").css("display", "none");
        }
    });
});
