...
Route::group(['middleware' => 'auth'], function(){
    ...
    */
    ...
    Route::get('/items/delete/{id}', [ItemController::class,'itemdelete']);
    ...
    Route::get('getchildcat/{id}', [ItemController::class,'getchildcat'])->name('getchildcat');
    Route::resource('items', '\App\Http\Controllers\ItemController');

    Route::get('attributedelete/{id}', [AttributeController::class,'attributedelete'])->name('attributedelete');
